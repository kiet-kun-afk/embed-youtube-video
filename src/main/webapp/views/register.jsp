        ...
        <div class="container-fluid tm-mt-60">
            <div class="row tm-mb-50">
                <div class="col-lg-12 col-12 mb-5">
                    ...
                    <form id="register-form" action="handle-register" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="captcha" id="captcha" class="form-control rounded-0"
                                value="${captcha}" placeholder="Captcha" pattern=".{5,}" required />
