						...
						<tbody>
							<c:forEach items="${videos}" var="item">
								<tr>
									...
									<td>
										<a id="edit${item.href}"
											href="<c:url value='/admin/video/edit?href=${item.href}'/>" type="button"
											class="btn btn-block btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Edit
										</a>
										<button id="delete${item.href}" type="button"
											onclick="deleteVideo('${item.href}')"
											class="btn btn-block btn-danger btn-sm"><i class="fas fa-trash"></i> Delete
										</button>
									</td>
								</tr>
							</c:forEach>
